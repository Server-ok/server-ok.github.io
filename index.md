...
### О себе.
Меня зовут [вставьте имя], живу я [вставьте ваш адрес]. Я программист, геймер, ютубер и просто человек (я не рептилоид, отвечаю).
Удачи вам!

### Языки проганья
Пока что знаю только JS и Python (список будет дополняться (это не точно))
### Контакты и ссылки

[ВК](https://vk.com/serverok2007)  
